...
final public class CollectionUtils {
     ...
     *
     * usage:
     * Operator { String category = "abc"}
     * List<Operator> operator = ...
     * Map<String, Set<Operator> operatorPerCategory = cGroupper(operator, Collectors.groupingBy(Operator::getCategory))
     *
     * @param collection -
     * @param collector -
     * @param <T> -
     ...
     *
     * usage:
     * Operator { Integer rating = 7;}
     * List<Operator> operators = ...
     * Map<Integer, Set<Operator> operatorPerRating = cGroupper(operators, Operator::getRating))
     *
     *
     * @param collection -
     * @param objMethod -
     ...
     *
     * usage:
     * Operator { Integer rating = 7; String name = "operator super"; }
     * List<Operator> operators = ...
     * Map<Integer, Set<String> operatorNamesPerRating = cGroupper(operators, Operator::getRating, Operator::getName))
     *
     * @param collection -
     * @param objMethodKey -
